...
func (ec *executionContext) field_Mutation_updateShape_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["boardId"] = arg0
	arg1, err := graphql.ProcessArgField(ctx, rawArgs, "shape", ec.unmarshalNShapeInput2serverᚐShapeInput)
	if err != nil {
		return nil, err
	}
	args["shape"] = arg1
...
func (ec *executionContext) _Board_shapes(ctx context.Context, field graphql.CollectedField, obj *Board) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNShape2ᚕᚖserverᚐShapeᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) _Query_board(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOBoard2ᚖserverᚐBoard,
		true,
		false,
	)
}
...
func (ec *executionContext) unmarshalInputShapeInput(ctx context.Context, obj any) (ShapeInput, error) {
	...
	fieldsInOrder := [...]string{"id", "type", "x", "y", "width", "height", "text"}
...
func (ec *executionContext) marshalNShape2serverᚐShape(ctx context.Context, sel ast.SelectionSet, v Shape) graphql.Marshaler {
	return ec._Shape(ctx, sel, &v)
}

func (ec *executionContext) marshalNShape2ᚕᚖserverᚐShapeᚄ(ctx context.Context, sel ast.SelectionSet, v []*Shape) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNShape2ᚖserverᚐShape(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNShape2ᚖserverᚐShape(ctx context.Context, sel ast.SelectionSet, v *Shape) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNShapeInput2serverᚐShapeInput(ctx context.Context, v any) (ShapeInput, error) {
...
func (ec *executionContext) marshalOBoard2ᚖserverᚐBoard(ctx context.Context, sel ast.SelectionSet, v *Board) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
